 ...
 * 前向ilqr算法
 * Template arguments:
 * X: number of dimensions of state space，状态空间维度
 * U: number of dimensions of action space，动作空间维度
 * T: horizon (number of discrete time steps)，时间步长
 */
...
struct ILQR {
   ...
   */
  //以下变量名称可能与通常的命名方案不同，以更好地与参考文献“通过在线轨迹优化实现复杂行为的合成和稳定”中使用的符号保持一致
